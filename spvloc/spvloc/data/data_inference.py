...
class Structured3DPlans_Inference(Dataset):
    ...
    def prepare_all_images(self, sample_list, rooms):
        ...
        for sample in sample_list:
            ...
            img_path = "../dataset/scene_03457/2D_rendering/141477/perspective/full/0/rgb_rawlight.png"



            #sample_path, _ = os.path.split(img_path)
            sample_path = "../dataset/scene_03457/2D_rendering/141477/perspective/full/0"
